...
while i<=50:
    if i < 10:
        firstimage = cv2.imread('dataset/00' + str(i) + '.jpg', cv2.IMREAD_GRAYSCALE)
    else:
        firstimage = cv2.imread('dataset/0' + str(i) + '.jpg', cv2.IMREAD_GRAYSCALE)
    ...
    if i<10:
        cv2.imwrite('Harris/Harris00' + str(i) + '.jpg', bgr)
    else:
        cv2.imwrite('Harris/Harris0' + str(i) + '.jpg', bgr)
